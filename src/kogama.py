...
class KoGaMa:
    ...
    async def post_feed_message(self, user_id : str, message : str):
        """
    ...
    async def post_feed_comment(self, feed_id : str, message : str):
        """
    ...
    async def post_game_comment(self, game_id : str, message : str):
        """ 
    ...
    async def post_model_comment(self, model_id : str, message : str):
        """
    ...
    async def post_avatar_comment(self, avatar_id : str, message : str):
        """ 
    ...
    async def post_news_comment(self, news_id : str, message : str):
        """   
    ...
    async def delete_game_comment(self, game_id : str, comment_id : str):
        """
    ...
    async def delete_model_comment(self, model_id : str, comment_id : str):
        """
    ...
    async def delete_avatar_comment(self, avatar_id : str, comment_id : str):
        """
    ...
    async def delete_feed_post(self, user_id : str, feed_id : str):
        """
        Deletes a Feed post.\n
    ...
    async def delete_feed_post_comment(self, feed_id : str, comment_id : str):
        """
    ...
    async def create_game(self, name : str, description='No description provided.', template='base'):
        """
        Creates an game.\n
        ...
        response = await self.session.post(f"{self.url}/game/",json={"name": name,"description": description,"proto_id": templates[template]})
        text =await response.text()
        if response.status == 429:
            raise too_many_requests("Chill, Cowboy! You are doing this too much, wait a little. [Status Code: 429]")
        elif "Unauthorized" in text:
    ...
    async def invite_member_to_game(self, game_id : str, user_id : str):
        """
    ...
    async def send_friend_request(self, friend_id : str):
        """
    ...
    async def cancel_friend_request(self, friend_id : str):
        """ 
    ...
    async def purchase_model(self, model_id : str):
        """
    ...
    async def purchase_avatar(self, avatar_id : str):
        """
    ...
    async def unlock_badge(self, badge_id : str):
        """
    ...
    async def like_game(self, game_id : str):
        """
        Likes a Game.\n
    ...
    async def like_model(self, model_id : str):
        """
        Likes a Model.\n
    ...
    async def like_avatar(self, avatar_id : str):
        """
        Likes an Avatar.\n
    ...
    async def get_model_comments(self, model_id : str, page='1', count='10'):
        """
    ...
    async def get_avatar_comments(self, avatar_id : str, page='1', count='10'):
        """
    ...
    async def get_user_feed_posts(self, user_id : str, page='1', count='10'):
        """
    ...
    async def get_feed_post_comments(self, feed_id : str, page='1', count='10'):
        """
    ...
    async def get_user_badges_ids(self, user_id : str, page='1', count='10'):
        """
